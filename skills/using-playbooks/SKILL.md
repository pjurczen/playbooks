...
- **Trivial changes** — describable in one sentence and verifiable with one command; a design would take longer to review than the change to make.
...
| Thought                                         | Reality                                                      |
|-------------------------------------------------|--------------------------------------------------------------|
| "I'll skip the skill, this is faster" | Speed isn't correctness. Invoke. |
