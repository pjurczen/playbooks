...
How this repo proves correctness and structure. Skills run these commands; none guesses one. The "code" here is markdown, so the gates are structural checks on the skill library.
...
## Rules enforced
- Word budgets: ≤ 1,000 per SKILL.md; 1,500 for `finishing-branch`, `executing-plans`, `consolidating-docs`; 1,200 for `writing-adr`, `brainstorming`; 500 for `using-playbooks`.
